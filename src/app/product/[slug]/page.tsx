...
export async function generateStaticParams() {
  // Prerender the top 240 winning products at build time for instant loading.
  // The remaining 4,760 products are rendered on demand and cached via Next.js ISR.
